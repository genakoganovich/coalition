        ...
        def func (serverConn):
            ...
            try:
                params = urllib.parse.urlencode ({
                    'hostname':self.Name,
                    'jobId':jobId,
                    'log':base64.b64encode (self.Log.encode('utf-8')).decode('ascii'),
    ...
    if serverUrl == "":
        ...
        while (gogogo):
            try:
                ...
                s.sendto (b"coalition", ('255.255.255.255', broadcastPort))
